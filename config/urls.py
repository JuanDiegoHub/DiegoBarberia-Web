...
urlpatterns = [
    ...
    path('citas/agendar/', views.agendar_cita_manual, name='agendar_cita_manual'),
    path('citas/reagendar/<int:cita_id>/', views.editar_cita_manual, name='editar_cita_manual'),
